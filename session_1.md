...
>
> They had error rates around 26 percent. Krizhevsky trains a deep neural network with eight layers, using two NVIDIA GPUs bought with a grant, and at the ECCV conference he presents his result. His network halves the error rate. Halves it.
>
...
>
> *[TA shows on screen — Figure 4 (Ultra-Intelligence, p. 17): Moore's law. Log-scale plot of compute operations per dollar from 1900 to the 2020s. The curve climbs 9 or 10 orders of magnitude, from the Analytical Engine through ENIAC, IBM 701, Apple II, IBM PC, Pentium II, GTX Titan, up to NVIDIA B100.]*
>
...
>
> *[TA shows on screen — Figure 15 (Ultra-Intelligence, p. 66): two impressionist-style landscape paintings side by side. One is by a canonical human artist. One is generated by a diffusion model. Audience is challenged to tell them apart. They will fail.]*
>
...
>
> Then Jack Good, in nineteen sixty-five, sitting somewhere, writes one paragraph that defines ultra-intelligence and the intelligence explosion in a way so precise that no frontier researcher in twenty twenty-six has had to add a word to it. That paragraph is the north star of this course and of the whole field. The first ultra-intelligent machine is the last invention man need ever make, provided that it is docile enough to tell us how to keep it under control. Every unsolved problem in AI alignment lives in those final fifteen words.
>
...
> Yes, and the credible window is the next two to five years, not fifteen. Some researchers disagree because they doubt current architectures can close the recursive self-improvement loop. The empirical trajectory does not support that doubt. Either way, the probability is high enough that you prepare for it, which is what the alignment field is doing.

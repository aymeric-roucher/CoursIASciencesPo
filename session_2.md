...
# 0. Cold open: the exponential is real (about 4 min)

**Key points:**

- Anchor with a single image: same prompt, two years apart, the gap is staggering.
- Pose the question without spoiling the answer: how far does this curve actually go?
- Set the tone: today is the session where we look the exponential in the face.

...
- Physical and relational jobs are likely to be the last to be automated. The "blue-collar revenge" is a real possibility: the plumber may out-earn the junior lawyer within a decade.
...
- But this time may be different, for two reasons. Quantitatively, growth is bounded by physical resources in a way it was not in 1870 (Figure 24, CO2 and GDP). Qualitatively, this is the first automation wave that touches cognition, not just muscle.
...
>
> A Stanford working paper published in late 2025, Brynjolfsson, Chandar, and Chen, tracked US employment data and found that among 20- to 30-year-olds in tech-exposed occupations, unemployment has risen by almost three percentage points since the start of 2025, while it has been roughly flat for older workers in the same occupations. (Stanford Digital Economy Lab, *Canaries in the Coal Mine?*, August 2025, [https://digitaleconomy.stanford.edu/wp-content/uploads/2025/08/Canaries_BrynjolfssonChandarChen.pdf](https://digitaleconomy.stanford.edu/wp-content/uploads/2025/08/Canaries_BrynjolfssonChandarChen.pdf).) The authors call these young workers "canaries in the coal mine." The intuition is simple. AI is a near-substitute for the junior version of a cognitive worker, someone who has book knowledge but not experience. It is a complement to the senior version, someone who has judgment and relationships. So the junior rungs of the ladder start to disappear, and nobody notices right away because the top of the ladder looks fine.
>
> Now I want to zoom out and ask: which jobs are safe? I will give you my best current guess, with the caveat that my crystal ball is cloudy.
>
> The jobs I think are structurally protected, at least for a decade, fall into four categories.
>
> First, jobs where the human element is itself part of the product. A live musician performing in front of an audience is not selling sound, if she were, we would all stay home with Spotify. She is selling the experience of being in the same room with a human who is making that sound right now. A therapist is not selling advice, she is selling presence. A priest, a nurse, a kindergarten teacher. These jobs will be augmented, but not automated, because the thing being purchased is the humanity itself.
>
> Second, jobs requiring dexterous physical intervention in an unstructured environment. The classical example is a plumber. A plumber has to crawl into a crawl space, identify a leak whose exact location is not known in advance, reach around an obstacle, work with a wrench at an awkward angle, and do all of this while managing a customer who is anxious about the flooded bathroom.
>
> This is called Moravec's paradox, the observation, going back to roboticist Hans Moravec in the 1980s, that what is easy for humans (walking, seeing, grasping) is extremely hard for machines, while what is hard for humans (chess, calculus, encyclopedic knowledge) has turned out to be relatively easy for machines. Chess fell to machines in 1997. Your plumber has not fallen.
>
> Robotics is making progress, we saw this in Session 4, but the progress is slow and costs remain high. A humanoid robot plumber that can match a human in a random bathroom is, I would guess, ten to fifteen years away, and maybe longer. This is the "blue-collar revenge" narrative. The world may be about to rediscover that the people who can actually fix the sink, rewire the circuit breaker, weld the beam, and tile the roof are extremely valuable. I would not be surprised if, within ten years, a master plumber in Paris earns more than a junior corporate lawyer.
>
> Third, jobs where a human is legally required to bear responsibility. A judge issuing a sentence. A surgeon holding the scalpel. A pilot in the cockpit. We can, technically, build systems that out-perform humans on parts of these jobs. We have been flying planes mostly on autopilot for thirty years. But the legal and political infrastructure requires a human on the hook. That is not going to disappear overnight.
>
> Fourth, jobs that involve running the political and civic architecture of society: elected politicians, senior civil servants, military commanders. The point here is not that these people could not be partially replaced; it is that the legitimacy of their decisions comes from their representing citizens, and citizens will not accept being governed by machines. At least, not yet.
>
> Everything else, and this is most of the labor market, is exposed, on a timeline of five to twenty years, to significant automation. Knowledge work is the most exposed. Finance, law, consulting, software development, journalism, translation, copywriting, design, research analyst roles, large parts of academia: all of these will look very different in ten years. Some of these jobs will disappear. Most will be reshaped. The question is whether there is enough new demand to absorb the freed-up labor.
>
> Let me turn to history. Because the pessimistic story I have just told is the pessimistic story we have told ourselves in every major technology wave, and most of the time, the pessimism has been wrong.
>
...
>
> Keynes saw all of this coming. In 1930, during the Great Depression, he wrote a short essay called "Economic Possibilities for our Grandchildren." He predicted that by 2030, a century later, exactly our decade, productivity would be so high that the average person would only need to work fifteen hours a week. He was approximately right about the productivity part.
>
> He was approximately wrong about the fifteen-hour week part. Why? Because we took the productivity gains in the form of higher consumption rather than more leisure.
>
...
>
> So the historical record is actually quite encouraging. Automation has always destroyed specific jobs, created new ones, and, on balance, raised living standards. Why should we expect anything different this time?
>
> I think there are two reasons to expect this time to be, if not entirely different, at least quantitatively different.
>
...
>
> Why does this matter for the labor-market question? Because the optimistic scenario for AI and jobs depends on rapid growth absorbing the freed-up labor. If AI makes each worker ten times more productive but the economic pie does not grow ten times, because physical constraints prevent it, then nine out of ten workers become redundant. The economy of 1870 did not hit these constraints; it had an entire planet to industrialize. The economy of 2030 cannot decarbonize fast enough to sustain the growth that would keep us all employed. That is the quantitative difference.
>
...
>
> So where does that leave us? I think it leaves us with a task, one of the central tasks of the next fifty years, in fact. The task is to separate *effort* from *employment*.
>
...
>
> So here is my tentative bottom line. A world without work is not automatically a dystopia. It is also not automatically a utopia. It is a world in which the meaning of a life will have to be made, individually and collectively, without the default scaffolding of a career. Our parents and grandparents could define themselves by their profession. You may have to define yourselves in other terms. That is hard. It is also, potentially, an opportunity for a kind of human flourishing that the industrial era never quite allowed.
>
...
- Dario Amodei, in *Machines of Loving Grace*, argues that once we have AI agents capable of autonomous research, we could compress the progress of the 21st century in biology into five to ten years.
...
>
> To set the stage, let me tell you about Réaumur. René-Antoine Ferchault de Réaumur was a French physicist and naturalist in the early 18th century. He is most famous for the Réaumur temperature scale, but his real achievement, for our purposes, was more prosaic. He oversaw the first systematic network of thermometers across France. And from the observation, obvious in retrospect, non-obvious at the time, that warmer weather accelerates the development of crops, he derived an equation for the flowering date of wheat as a function of accumulated "degree-days" above a threshold temperature. That equation is still in use today, three hundred years later.
>
> Here is what I want you to notice. Réaumur's original paper, published in the Mémoires de l'Académie royale des sciences in 1735, is full of tables of observations, pages and pages of numbers. Today, the computation Réaumur did by hand in weeks of painful tabulation would take a single line of code in Python, running in milliseconds, on data sets a thousand times larger. Computing did not just speed up Réaumur's method; it made it trivial.
>
...
>
> Consider a concrete example from my own field. A scientist reading papers, say a biologist trying to keep up with literature on Alzheimer's disease, can, in a focused week, read maybe thirty papers deeply and skim another hundred. The global literature on Alzheimer's disease publishes roughly ten thousand papers a year.
>
> She is reading one percent. An AI system with access to the literature can, in seconds, scan all ten thousand, summarize them, cluster them by topic, flag contradictions, and surface the three papers most relevant to her specific question. This is not science fiction; tools like Elicit, Consensus, and the various "deep research" modes in Claude and GPT already do this, imperfectly. They will do it much better in five years.
>
> Now let us go deeper. Dario Amodei, the CEO of Anthropic and, more relevantly, a neuroscientist before he became an AI entrepreneur, published an essay in October 2024 called *Machines of Loving Grace*. (Amodei, *Machines of Loving Grace*, [https://www.darioamodei.com/essay/machines-of-loving-grace](https://www.darioamodei.com/essay/machines-of-loving-grace).) It is fourteen thousand words. I think it is the single best essay that has been written about what AI could mean for the good of humanity, and I recommend you read it in full tonight. The core thesis is this. Once we have AI systems capable of conducting research largely autonomously, and Amodei thinks this is coming in a handful of years, we could compress the scientific progress of the 21st century in biology into a window of five to ten years.
>
...
>
> The first major experimental confirmation of this argument is AlphaFold. You probably heard about this in the news. AlphaFold, developed by a team at Google DeepMind led by Demis Hassabis and John Jumper, is a deep-learning system that predicts, from the amino-acid sequence of a protein, the three-dimensional shape that protein folds into. This is the protein-folding problem, which had been an open problem in biology for fifty years. The previous state of the art required an experimental technique called X-ray crystallography, which takes months per protein and costs many thousands of dollars. AlphaFold predicts the shape in seconds, and the predictions are, for most proteins, at the resolution an expert experimentalist would produce.
>
> DeepMind released the structures of essentially every protein known to biology, roughly 200 million structures, in an open database. For comparison, before AlphaFold, humanity had experimentally determined the structures of perhaps 200 thousand proteins. In one stroke, AlphaFold multiplied the available protein-structure data by a thousand. Hassabis and Jumper won the 2024 Nobel Prize in Chemistry for this. That Nobel was, in my opinion, the real coming-out party for AI as a first-class scientific tool.
>
...
>
> Does that mean AI is going to start winning Nobels in five years? Probably not. The bar for a Nobel-level contribution is very high, and there are qualitative aspects, the taste, the instinct for which problem is worth pursuing, the courage to spend ten years on something before you know it will work, that AI systems do not yet have. But on the scale between "useful assistant" and "autonomous scientist," I think we are going to move very rapidly over the next decade.
>
...
>
> Let me address the hype skeptics, because there are also good arguments on the other side.
>
> The first counter-argument is the diminishing-returns hypothesis. In 1905, Einstein, at twenty-six, published the three papers that revolutionized physics, special relativity, Brownian motion, the photoelectric effect. Henri Poincaré, around the same time, was producing fundamental results in every major area of pure mathematics.
>
...
>
> The second counter-argument is experimental. Some scientific progress requires running experiments in the real world, and the real world has its own clock. A clinical trial takes years. An astronomical observation may require a space telescope. Even a superintelligence cannot make a three-year drug trial take less than three years, unless we restructure the regulatory apparatus around drug approval, which is a different problem.
>
> Put these two together, diminishing returns on ideas, irreducible experimental time, and you get a picture in which AI accelerates science a lot, but not infinitely. Maybe we get the scientific output of the next century in twenty years, not five. Still a huge win.
>
...
>
> That is the most precise statement of what we now call the Singularity hypothesis. Ray Kurzweil, building on Good, argued in the 2000s that the Singularity would arrive around 2045. I have no idea whether he is right about the date, and neither, really, does anyone else. But the basic mechanism, that intelligence, if it is amplifiable by intelligence, will amplify itself, is sound. Whether the counterforces (diminishing returns, experimental time, resource constraints) slow the explosion to a merely rapid acceleration, or whether nothing slows it, is the great unknown.
>
> What should you take from all this, practically? Two things. First, science is about to get a lot more productive, and many of the problems that have felt intractable to humanity, cancer, aging, fusion energy, climate mitigation technology, may become tractable in your professional lifetime. Second, the frontier of knowledge is about to move faster than any individual human can follow, which means the role of a scientist will shift. The questions of taste, which problems are worth solving, which answers are worth listening to, which directions are worth pursuing, will matter more, not less. The drudgery will vanish, but the judgment will remain.
...
>
> Let me give you some numbers. At the time of the iPhone launch in 2007, which is, in my opinion, arguably the most important technological event of the early 21st century, the average person spent roughly three hours a day looking at a screen. Today, the average person spends about seven hours a day looking at a screen, including roughly four hours on a smartphone. That is seven hours out of sixteen waking hours. Almost half the waking life of an average human in 2026 is spent staring at a small glowing rectangle.
>
...
>
> So what do these companies do? They run, every day, thousands of experiments, A/B tests, on small slices of their user base. They try a new recommendation algorithm on one percent of users; they measure engagement; if it raises time-on-platform, they ship it.
>
...
>
> Reed Hastings, the CEO of Netflix, said more recently: "Our biggest competitor is sleep." Read that sentence carefully. Netflix does not see itself as competing with HBO. It does not see itself as competing with Disney. It sees itself as competing with your sleep, with the seven or eight hours when, inconveniently, you are not watching Netflix.
>
...
- Specific concrete advice: learn the tools, read the good sources, join the conversation, be skeptical of both the doomers and the hype-artists.
...
>
> I want to give you some concrete advice for the next five to ten years. Take it for what it is worth, the advice of an engineer who happens to have written a book, not the advice of a prophet.
>
> First, learn the tools. Deeply. Not as a user, not at the level of "I know how to write a prompt." At the level of understanding what is going on under the hood, so that when you read a news article you can evaluate whether the article knows what it is talking about. You already have a head start; you took this course. Keep going. Read the papers. Play with the APIs. Build small projects. Ten hours of playing with Claude Code will teach you more than fifty hours of reading about AI.
>
...
>
> Fourth, be skeptical of both the doomers and the hype-artists. The person telling you that AI will solve all of humanity's problems next year is selling you a product. The person telling you that AI is a bubble that will pop in 18 months is also selling you a product, usually in the form of clicks. Neither of them is right. The reality is a slower, weirder, more uneven transformation, with moments of spectacular acceleration punctuated by moments of embarrassing failure. Hold the tension. Do not resolve it too quickly.
>
> Fifth, look after your own interior life. This is the advice that I think is most important, and also the advice that is least heard. You are going to spend the next fifty years living inside an environment specifically optimized to capture your attention. The defense against that environment is not technical. It is, I think, spiritual, in the broadest, most non-denominational sense. Cultivate habits of attention. Read difficult books slowly. Write by hand. Walk without your phone. Sit quietly in a room alone, which, as Pascal warned us, is a capacity we are losing. These are not luxuries. These are the load-bearing habits of a functioning self, and they are under direct attack.
>
> Lastly, do not be afraid. I say this with a certain urgency. We will see more and more bright young people fall into a kind of anticipatory grief about AI. This is a trap. Whatever happens in the next twenty years, you are going to live through it, and you are going to be an actor in it, and the people who showed up, the people who kept studying, kept building, kept loving, kept voting, are going to be the people whose preferences shape what happens. The people who dropped out because they thought it was hopeless are going to be shaped by other people's preferences. Choose to be the first kind.
>
...
>
> First: "Are you optimistic or pessimistic?" My honest answer is: I am not sure those are the right categories. I think the outcome is not determined. I think there are trajectories in which humanity comes out of this transformation enormously better off, healthier, freer, richer in both the material and the non-material sense, and trajectories in which we come out materially better off but spiritually broken, and trajectories in which we fracture badly. I think the choice between those trajectories is being made, unevenly and distributedly, right now. Being optimistic or pessimistic is a matter of temperament. Being engaged is a matter of duty.
>

...
>
> The book gives a 4-dimensional toy example. Take "chiot" (puppy) as a vector with 0.0 on the feminine axis, 1.0 on the animal axis, 0.1 on the old axis, 0.3 on the fast axis. Take "doyenne" (elderly woman) as 1.0, 0.0, 0.9, 0.1 on those same 4 axes. You can now do doyenne minus chiot, and you get 1.0, minus 1.0, 0.8, minus 0.2. That difference vector captures, roughly, "become human, become old". That arithmetic extends to real 300-dimensional vectors trained on real text, and yes, in the real space, king minus man plus woman really lands almost exactly on queen.
>
...
- Human intuition is poorly calibrated for exponentials. > I want to flag one last thing before we close, because I think it is a mental habit your generation will need: getting used to exponentials.
>
